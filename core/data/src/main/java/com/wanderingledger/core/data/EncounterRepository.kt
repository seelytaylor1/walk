...
class EncounterRepository(
     ...
     */
    suspend fun resolveRoadEncounter(seed: Long, encounterId: String): EncounterOutcome {
        ...
        database.withTransaction {
            ...
            database.eventLogDao().insertEvent(
                EventLogEntity(
                    type = "encounter",
                    meta = "{\"encounterId\":\"$encounterId\",\"success\":${outcome.success},\"goldChange\":${outcome.goldChange}}",
