...
class CompanionRecruitmentGateTest {
    ...
    @Test
    fun `AC-14 recruitment blocked before 3 completed trades`() =
        runTest {
    ...
    @Test
    fun `AC-14 recruitment allowed after 3 completed trades`() =
        runTest {
            val miraId = 1L
    ...
    @Test
    fun `AC-14 trade count increments on buy and sell`() =
        runTest {
            marketRepository.buyGood(townId = 1L, goodId = 1L, quantity = 1)
